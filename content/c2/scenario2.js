...
window.SCENARIOS['c2'] = {
  ...
  id:    'c2',
  title: '항일 무장 투쟁 인터랙티브 — 내가 독립군 대장이라면',
  base:  'content/c2/',        // 아래 모든 경로의 기준
  aspect: '16:9',
  ...
  menu: {
    badge: '제2편',
    label: '내가 독립군 대장이었다면',
    desc:  '1920년, 독립군을 공격하기 위해 일본군 병력이 온다'
  },
  ...
  nodes: {
    ...
    q0: {
      type:  'video',
      src:   'video/c2_main-1_1.mp4',
      badge: '1920년',
      title: '내가 독립군 대장이면 어떤 작전을 선택할까?'
    ...
    hub: {
      ...
      dim:  0.25,
      delay: 200,
      question: '독립군은 어떤 작전을 펼쳤을까?',
      sfx:       { src: 'audio/whoosh.mp3',   delay: 200, volume: 0.7 },
      narration: { src: 'audio/hub_narr.mp3', delay: 800, volume: 0.8 },
      options: [
        { label: '일본군이 도착하기 전에 넓은 곳에서 싸운다.', go: 'a1' },
        { label: '지형이 유리한 곳에서 일본군을 기습한다.',       go: 'a2' },
        { label: '일단 흩어져 이동하고 다음 기회를 노린다.',            go: 'a3' }
      ],
    ...
    a1: {
      type:  'video',
      src:   'video/c2_opt-1_1.mp4',
      title: '일본군이 도착하기 전에 넓은 곳에서 싸운다.'
    },

    a2: {
      type:  'video',
      src:   'video/c2_opt-2_1.mp4',
      title: '지형이 유리한 곳에서 일본군을 기습한다.'
    },

    a3: {
      type:  'video',
      src:   'video/c2_opt_3_1.mp4',
      title: '일단 흩어져 이동하고 다음 기회를 노린다.'
    }
